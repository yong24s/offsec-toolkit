...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder "./enumeration", "/home/vagrant/scripts/enumeration", id: "enumeration"
  config.vm.synced_folder "./shared", "/home/vagrant/shared", id: "shared"
  ...
  config.vm.provision "shell", privileged: false, inline: <<-SHELL
    ...
    ~/.pyenv/bin/pyenv install 2.7.16
    ~/.pyenv/bin/pyenv global 2.7.16
